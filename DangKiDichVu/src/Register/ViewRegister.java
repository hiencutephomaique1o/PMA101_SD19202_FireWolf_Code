...
public class ViewRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ĐĂNG KÝ DỊCH VỤ");
        jLabel1.setToolTipText("");

        jLabel3.setText("Loại dịch vụ:");

        cbbLoaiDichVu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Dịch vụ nghỉ phép", "Dịch vụ cấp lại thẻ", "Dịch vụ thay đổi thông tin ", "Dịch vụ thay đổi lịch dạy", "Dịch vụ khác" }));
